...
namespace Sixnet.Development.Events.Data
{
    ...
    /// </summary>
    internal class SixnetDefaultCascadingDeletingAsyncEventHandler<TRelationEntity> : ISixnetEventHandler
    {
        ...
        {
            SixnetDirectThrower.ThrowSixnetExceptionIf(eventData is not SixnetCascadingDeletingAsyncDataEvent, "Event is not a deleting event");

            var deletingDataEvent = eventData as SixnetCascadingDeletingAsyncDataEvent;
