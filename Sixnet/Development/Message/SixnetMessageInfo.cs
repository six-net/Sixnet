...
namespace Sixnet.Development.Message
{
    ...
    /// Message info
    /// </summary>
    public class SixnetMessageInfo
    {
        /// <summary>
        ...
        /// </summary>
        public string WorkId { get; set; } = SixnetUnitOfWork.Current?.WorkId;
        ...
        /// </summary>
        public SixnetMessageSendTime SendTime { get; set; } = SixnetMessageSendTime.WorkCompleted;
