...
namespace Sixnet.Development.Data.Parameter.Handler
{
    ...
    /// </summary>
    public class DefaultDataCommandParameterHandler : ISixnetDataCommandParameterHandler
    {
        readonly Func<DataCommandParameterItem, DataCommandParameterItem> _handler = null;

        public DefaultDataCommandParameterHandler(Func<DataCommandParameterItem, DataCommandParameterItem> handleParameterDelegate)
        {
