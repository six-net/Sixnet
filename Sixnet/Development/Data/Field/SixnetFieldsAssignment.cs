...
namespace Sixnet.Development.Data.Field
{
    ...
    /// Fields assignment
    /// </summary>
    public class SixnetFieldsAssignment : ISixnetCloneable<SixnetFieldsAssignment>
    {
        #region Fields
        ...
        public SixnetFieldsAssignment Clone()
        {
            return new SixnetFieldsAssignment()
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static SixnetFieldsAssignment Create()
        {
            return new SixnetFieldsAssignment();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static SixnetFieldsAssignment Create<T>(Expression<Func<T, bool>> updateExpression)
        {
