...
namespace Sixnet.Development.Data.Field
{
    ...
    /// Constant field
    /// </summary>
    public class SixnetConstantField : ISixnetField
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static SixnetConstantField Create(dynamic value, string outputName = "")
        {
            return new SixnetConstantField()
            {
        ...
        public override bool Equals(object obj)
        {
            if (!base.Equals(obj))
            {
                return obj is SixnetConstantField constantField
