...
namespace Sixnet.Development.Data.Interceptor
{
    ...
    public class InterceptDataContext
    {
        ...
        /// </summary>
        internal DataCommand DataCommand { get; set; }
        ...
        {
            ThrowHelper.ThrowFrameworkErrorIf(!HasNewValue(fieldName), $"Not set new value for {fieldName}");
        ...
        {
            ThrowHelper.ThrowFrameworkErrorIf(!HasOldValue(fieldName), $"Not has original value for {fieldName}");
        ...
        internal bool AllowUpdateNewValue(Type valueType, string fieldName)
        {
            ...
            if (hasValue)
            {
                ...
                var realValue = value;
                if (value is IDataField dataField)
                {
