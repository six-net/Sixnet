...
namespace Sixnet.Development.Data.Command
{
    ...
    /// </summary>
    public class SixnetDataCommandResolveContext
    {
        #region Fields
        ...
        SixnetDataCommandParameters parameters;
        ...
        /// Data access context
        /// </summary>
        public SixnetDataCommandExecutionContext DataCommandExecutionContext { get; private set; }
        ...
        public SixnetDataCommandResolveContext(SixnetDatabaseConnection connection, SixnetDataCommand command)
        {
            DataCommandExecutionContext = SixnetDataCommandExecutionContext.Create(connection, command);
        ...
        /// </summary>
        /// <returns></returns>
        public SixnetDataCommandParameters GetParameters()
        {
            return parameters;
        }
        ...
        public string AddParameterByKeyword(string parameterNameKeyword, dynamic value)
        {
            ...
            parameters ??= new SixnetDataCommandParameters();
        ...
        public void SetParameters(SixnetDataCommandParameters newParameters)
        {
        ...
        /// <param name="queryableLocation">Activity queryable location</param>
        /// <returns>Return table name</returns>
        public async Task<List<SixnetDatabaseObjectName>> GetTableNamesAsync(ISixnetQueryable activityQueryable, SixnetQueryableLocation queryableLocation)
        {
