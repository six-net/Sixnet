...
namespace Sixnet.Development.Data.Command.Event
{
    ...
    /// </summary>
    internal class HandlingDataCommandQueryableStartingEventHandler : IDataCommandStartingEventHandler
    {
        public void Handle(DataCommandStartingEvent dataCommandStartingEvent)
        {
            ...
            {
                var versionFieldName = EntityManager.GetRoleFieldName(entityType, FieldRole.Revision);
