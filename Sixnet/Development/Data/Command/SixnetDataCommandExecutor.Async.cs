...
namespace Sixnet.Development.Command
{
    ...
    internal partial class SixnetDataCommandExecutor
    {
        ...
        public static async Task<List<T>> QueryAsync<T>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, SixnetDataOperationOptions options = null)
        {
            ...
            {
                queryTasks[taskIndex] = conn.DatabaseProvider.QueryAsync<T>(GetDatabaseSingleCommand<SixnetSingleDatabaseCommand>(conn, queryCommand, options));
                taskIndex++;
            }
        ...
        public static async Task<T> QueryFirstAsync<T>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, SixnetDataOperationOptions options = null)
        {
            ...
            foreach (var conn in connections)
            {
                data = await conn.DatabaseProvider.QueryFirstAsync<T>(GetDatabaseSingleCommand<SixnetSingleDatabaseCommand>(conn, queryCommand, options)).ConfigureAwait(false);
                if (data != null)
                {
                    break;
                }
        ...
        public static async Task<SixnetPagingInfo<T>> QueryPagingAsync<T>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            ...
            var pagingTasks = new Task<SixnetPagingInfo<T>>[connections.GetCount()];
            var taskIndex = 0;
            foreach (var conn in connections)
            {
        ...
        static async Task<SixnetPagingInfo<T>> SingleServerPagingAsync<T>(SixnetDatabaseConnection connection, SixnetDataCommand queryCommand, SixnetDataOperationOptions options = null)
        {
            var provider = connection.DatabaseProvider;
            return await provider.QueryPagingAsync<T>(GetDatabaseSingleCommand<SixnetSingleDatabaseCommand>(connection, queryCommand, options)).ConfigureAwait(false);
        }
        ...
        public static async Task<List<TReturn>> QueryMappingAsync<TFirst, TSecond, TReturn>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, Func<TFirst, TSecond, TReturn> dataMappingFunc, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static async Task<List<TReturn>> QueryMappingAsync<TFirst, TSecond, TThird, TReturn>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, Func<TFirst, TSecond, TThird, TReturn> dataMappingFunc, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var queryTasks = new Task<List<TReturn>>[connections.GetCount()];
            var taskIndex = 0;
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static async Task<List<TReturn>> QueryMappingAsync<TFirst, TSecond, TThird, TFourth, TReturn>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, Func<TFirst, TSecond, TThird, TFourth, TReturn> dataMappingFunc, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var queryTasks = new Task<List<TReturn>>[connections.GetCount()];
            var taskIndex = 0;
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static async Task<List<TReturn>> QueryMappingAsync<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, Func<TFirst, TSecond, TThird, TFourth, TFifth, TReturn> dataMappingFunc, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var queryTasks = new Task<List<TReturn>>[connections.GetCount()];
            var taskIndex = 0;
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static async Task<List<TReturn>> QueryMappingAsync<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn> dataMappingFunc, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var queryTasks = new Task<List<TReturn>>[connections.GetCount()];
            var taskIndex = 0;
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static async Task<List<TReturn>> QueryMappingAsync<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn> dataMappingFunc, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var queryTasks = new Task<List<TReturn>>[connections.GetCount()];
            var taskIndex = 0;
        ...
        public static async Task<bool> ExistsAsync(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            ...
            foreach (var conn in connections)
            {
                queryTasks[taskIndex] = conn.DatabaseProvider.ExistsAsync(GetDatabaseSingleCommand<SixnetSingleDatabaseCommand>(conn, queryCommand, options));
                taskIndex++;
            }
        ...
        public static async Task<int> CountAsync(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var countTasks = new List<Task<int>>();
            foreach (var conn in connections)
            {
                countTasks.Add(conn.DatabaseProvider.CountAsync(GetDatabaseSingleCommand<SixnetSingleDatabaseCommand>(conn, queryCommand, options)));
            }
        ...
        public static async Task<TValue> ScalarAsync<TValue>(IEnumerable<SixnetDatabaseConnection> connections, SixnetDataCommand queryCommand, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            ...
            foreach (var conn in connections)
            {
                scalarTasks[taskIndex] = conn.DatabaseProvider.ScalarAsync<TValue>(GetDatabaseSingleCommand<SixnetSingleDatabaseCommand>(conn, queryCommand, options));
                taskIndex++;
            }
        ...
        public static async Task<DataSet> QueryMultipleAsync(IEnumerable<SixnetDatabaseConnection> connections, IEnumerable<SixnetDataCommand> queryCommands, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static async Task<Tuple<List<TFirst>, List<TSecond>>> QueryMultipleAsync<TFirst, TSecond>(IEnumerable<SixnetDatabaseConnection> connections, IEnumerable<SixnetDataCommand> queryCommands, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static async Task<Tuple<List<TFirst>, List<TSecond>, List<TThird>>> QueryMultipleAsync<TFirst, TSecond, TThird>(IEnumerable<SixnetDatabaseConnection> connections, IEnumerable<SixnetDataCommand> queryCommands, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static async Task<Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>>> QueryMultipleAsync<TFirst, TSecond, TThird, TFourth>(IEnumerable<SixnetDatabaseConnection> connections, IEnumerable<SixnetDataCommand> queryCommands, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static async Task<Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>>> QueryMultipleAsync<TFirst, TSecond, TThird, TFourth, TFifth>(IEnumerable<SixnetDatabaseConnection> connections, IEnumerable<SixnetDataCommand> queryCommands, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static async Task<Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>, List<TSixth>>> QueryMultipleAsync<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(IEnumerable<SixnetDatabaseConnection> connections, IEnumerable<SixnetDataCommand> queryCommands, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static Task<List<SixnetDataTable>> GetTablesAsync(SixnetDatabaseConnection connection, SixnetDataOperationOptions options = null)
        {
            return connection.DatabaseProvider.GetTablesAsync(SixnetDatabaseCommand.Create(connection, options));
        }
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static async Task<int> ExecuteAsync(IEnumerable<SixnetDatabaseConnection> connections, IEnumerable<SixnetDataCommand> commands, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            // single connection
            if (connections.GetCount() == 1)
        ...
        public static async Task<Dictionary<string, TIdentity>> InsertAndReturnAutoIdentityAsync<TIdentity>(IEnumerable<SixnetDatabaseConnection> connections, IEnumerable<SixnetDataCommand> commands, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            // single connection
            if (connections.GetCount() == 1)
        ...
        /// <param name="options">Data operation options</param>
        public static Task MigrateAsync(IEnumerable<SixnetDatabaseConnection> connections, SixnetMigrationInfo migrationInfo, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        public static async Task CreateTableAsync(IEnumerable<SixnetDatabaseConnection> connections, Type entityType, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            foreach (var connection in connections)
            {
        ...
        /// <param name="entityType"></param>
        /// <param name="options"></param>
        public static async Task DeleteTableAsync(IEnumerable<SixnetDatabaseConnection> connections, List<Type> entityTypes, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            foreach (var connection in connections)
            {
                var allTablesNames = (await connection.DatabaseProvider.GetTablesAsync(SixnetDatabaseCommand.Create(connection, options)).ConfigureAwait(false))?.Select(c => c.GetDatabaseObjectName()).ToList();
        ...
        /// <param name="options"></param>
        public static async Task AddFieldAsync(IEnumerable<SixnetDatabaseConnection> connections, Type entityType, List<SixnetDataField> fields, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            foreach (var connection in connections)
            {
                await connection.DatabaseProvider.MigrateAsync(GetAddFieldCommand(connection, (await connection.DatabaseProvider.GetTablesAsync(SixnetDatabaseCommand.Create(connection, options)).ConfigureAwait(false))?.Select(c => c.GetDatabaseObjectName()).ToList(), entityType, fields, options));
            }
        }
        ...
        /// <param name="fields"></param>
        /// <param name="options"></param>
        public static async Task DeleteFieldAsync(IEnumerable<SixnetDatabaseConnection> connections, Type entityType, List<SixnetDataField> fields, SixnetDataOperationOptions options = null)
        {
            ValidateConnections(connections);
            foreach (var connection in connections)
            {
                await connection.DatabaseProvider.MigrateAsync(GetDeleteFieldCommand(connection, (await connection.DatabaseProvider.GetTablesAsync(SixnetDatabaseCommand.Create(connection, options)).ConfigureAwait(false))?.Select(c => c.GetDatabaseObjectName()).ToList(), entityType, fields, options));
            }
        }
        ...
        /// <param name="fields"></param>
        /// <param name="options"></param>
        public static async Task AlterFieldAsync(IEnumerable<SixnetDatabaseConnection> connections, Type entityType, Dictionary<string, SixnetDataField> fields, SixnetDataOperationOptions options)
        {
            ValidateConnections(connections);
            foreach (var connection in connections)
            {
