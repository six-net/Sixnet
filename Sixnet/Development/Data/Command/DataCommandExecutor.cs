...
namespace Sixnet.Development.Command
{
    ...
    internal partial class DataCommandExecutor
    {
        ...
        public static List<T> Query<T>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var datas = new List<T>();
            foreach (var conn in connections)
            {
                var connDatas = conn.DatabaseProvider.Query<T>(GetDatabaseSingleCommand<DatabaseSingleCommand>(conn, queryCommand, options));
        ...
        /// <param name="options">Data operation options</param>
        /// <returns>Data list</returns>
        public static T QueryFirst<T>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            ...
            foreach (var conn in connections)
            {
                data = conn.DatabaseProvider.QueryFirst<T>(GetDatabaseSingleCommand<DatabaseSingleCommand>(conn, queryCommand, options));
                if (data != null)
                {
                    break;
                }
        ...
        public static PagingInfo<T> QueryPaging<T>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        static PagingInfo<T> SingleServerPaging<T>(DatabaseConnection connection, DataCommand queryCommand, DataOperationOptions options = null)
        {
            var provider = connection.DatabaseProvider;
            return provider.QueryPaging<T>(GetDatabaseSingleCommand<DatabaseSingleCommand>(connection, queryCommand, options));
        }
        ...
        public static List<TReturn> QueryMapping<TFirst, TSecond, TReturn>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, Func<TFirst, TSecond, TReturn> dataMappingFunc, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static List<TReturn> QueryMapping<TFirst, TSecond, TThird, TReturn>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, Func<TFirst, TSecond, TThird, TReturn> dataMappingFunc, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var datas = new List<TReturn>();
            foreach (var conn in connections)
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static List<TReturn> QueryMapping<TFirst, TSecond, TThird, TFourth, TReturn>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, Func<TFirst, TSecond, TThird, TFourth, TReturn> dataMappingFunc, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var datas = new List<TReturn>();
            foreach (var conn in connections)
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static List<TReturn> QueryMapping<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, Func<TFirst, TSecond, TThird, TFourth, TFifth, TReturn> dataMappingFunc, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var datas = new List<TReturn>();
            foreach (var conn in connections)
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static List<TReturn> QueryMapping<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn> dataMappingFunc, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var datas = new List<TReturn>();
            foreach (var conn in connections)
        ...
        /// <param name="options">Options</param>
        /// <returns>Return the datas</returns>
        public static List<TReturn> QueryMapping<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn> dataMappingFunc, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var datas = new List<TReturn>();
            foreach (var conn in connections)
        ...
        public static bool Exists(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            foreach (var conn in connections)
            {
                if (conn.DatabaseProvider.Exists(GetDatabaseSingleCommand<DatabaseSingleCommand>(conn, queryCommand, options)))
                {
                    return true;
                }
            }
        ...
        public static int Count(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var count = 0;
            foreach (var conn in connections)
            {
                count += conn.DatabaseProvider.Count(GetDatabaseSingleCommand<DatabaseSingleCommand>(conn, queryCommand, options));
            }
            return count;
        }
        ...
        public static TValue Scalar<TValue>(IEnumerable<DatabaseConnection> connections, DataCommand queryCommand, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var values = new List<TValue>();
            foreach (var conn in connections)
            {
                values.Add(conn.DatabaseProvider.Scalar<TValue>(GetDatabaseSingleCommand<DatabaseSingleCommand>(conn, queryCommand, options)));
            }
        ...
        public static DataSet QueryMultiple(IEnumerable<DatabaseConnection> connections, IEnumerable<DataCommand> queryCommands, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static Tuple<List<TFirst>, List<TSecond>> QueryMultiple<TFirst, TSecond>(IEnumerable<DatabaseConnection> connections, IEnumerable<DataCommand> queryCommands, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static Tuple<List<TFirst>, List<TSecond>, List<TThird>> QueryMultiple<TFirst, TSecond, TThird>(IEnumerable<DatabaseConnection> connections, IEnumerable<DataCommand> queryCommands, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>> QueryMultiple<TFirst, TSecond, TThird, TFourth>(IEnumerable<DatabaseConnection> connections, IEnumerable<DataCommand> queryCommands, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>> QueryMultiple<TFirst, TSecond, TThird, TFourth, TFifth>(IEnumerable<DatabaseConnection> connections, IEnumerable<DataCommand> queryCommands, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>, List<TSixth>> QueryMultiple<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(IEnumerable<DatabaseConnection> connections, IEnumerable<DataCommand> queryCommands, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static List<DatabaseTableInfo> GetTables(DatabaseConnection connection, DataOperationOptions options = null)
        {
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static int Execute(IEnumerable<DatabaseConnection> connections, IEnumerable<DataCommand> commands, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
            var value = 0;
            foreach (var conn in connections)
        ...
        public static Dictionary<string, TIdentity> InsertAndReturnAutoIdentity<TIdentity>(IEnumerable<DatabaseConnection> connections, IEnumerable<DataCommand> commands, DataOperationOptions options = null)
        {
            ValidateConnections(connections);
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        public static void BulkInsert(IEnumerable<DatabaseConnection> connections, DataTable dataTable, IBulkInsertionOptions options = null)
        {
            ValidateConnections(connections);
            foreach (var conn in connections)
            {
        ...
        public static void Migrate(IEnumerable<DatabaseConnection> connections, MigrationInfo migrationInfo, DataOperationOptions options = null)
        {
            ...
            {
                connection.DatabaseProvider.Migrate(new DatabaseMigrationCommand()
                {
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        static TDatabaseCommand GetDatabaseSingleCommand<TDatabaseCommand>(DatabaseConnection connection, DataCommand dataCommand, DataOperationOptions options) where TDatabaseCommand : DatabaseSingleCommand, new()
        {
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        static DatabaseMultipleCommand GetDatabaseMultipleCommand(DatabaseConnection connection, IEnumerable<DataCommand> commands, DataOperationOptions options)
        {
            ThrowHelper.ThrowArgNullIf(commands.IsNullOrEmpty(), $"{nameof(commands)} is null or empty");

            return new DatabaseMultipleCommand()
            {
                Connection = connection,
                CancellationToken = options?.CancellationToken ?? default,
                DataCommands = commands?.ToList() ?? new List<DataCommand>()
            };
        }
        ...
        /// <param name="options">Options</param>
        /// <returns></returns>
        static DatabaseBulkInsertCommand GetDatabaseBulkInsertCommand(DatabaseConnection connection, DataTable dataTable, IBulkInsertionOptions options = null)
        {
            return new DatabaseBulkInsertCommand()
            {
                Connection = connection,
        ...
        {
            ThrowHelper.ThrowArgNullIf(connections.IsNullOrEmpty(), $"{nameof(connections)} is null or empty");
        }
