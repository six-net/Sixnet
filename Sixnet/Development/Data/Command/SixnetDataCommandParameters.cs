...
namespace Sixnet.Development.Data.Command
{
    ...
    /// </summary>
    [Serializable]
    public class SixnetDataCommandParameters
    {
        /// <summary>
        /// Items
        /// </summary>
        ...
        /// </summary>
        /// <param name="parameters">Parameters</param>
        public SixnetDataCommandParameters Union(params SixnetDataCommandParameters[] parameters)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public SixnetDataCommandParameters Clone()
        {
            return new SixnetDataCommandParameters()
            {
        ...
        public static SixnetDataCommandParameters Parse(object originalParameters)
        {
            if (originalParameters == null)
            {
                return null;
            }
            if (originalParameters is SixnetDataCommandParameters commandParameters)
            {
                return commandParameters;
            }
            commandParameters = new SixnetDataCommandParameters();
