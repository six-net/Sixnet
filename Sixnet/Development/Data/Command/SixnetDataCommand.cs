...
namespace Sixnet.Development.Data.Command
{
    ...
    /// </summary>
    public class SixnetDataCommand
    {
        private SixnetDataCommand()
        {
            Id = CreateCommandId();
        }
        ...
        /// </summary>
        readonly List<ISixnetDataCommandStartingEventHandler> StartingEventHandlers = new();

        /// <summary>
        /// Sync callback event handlers
        /// </summary>
        readonly List<ISixnetDataCommandCallbackEventHandler> CallbackEventHandlers = new();
        ...
        /// <param name="queryable">Queryable</param>
        /// <returns></returns>
        public static SixnetDataCommand CreateQueryCommand<TEntity>(ISixnetQueryable queryable)
        {
            var entityType = queryable?.GetModelType();
            if (entityType == null)
            {
        ...
        /// <param name="queryable">Queryable</param>
        /// <returns></returns>
        public static SixnetDataCommand CreateQueryCommand(ISixnetQueryable queryable)
        {
            var entityType = queryable?.GetModelType();
            return new SixnetDataCommand()
            {
        ...
        /// <returns></returns>
        public static SixnetDataCommand Create(DataTable dataTable)
        {
            return new SixnetDataCommand()
            {
        ...
        public void SubscribeStartingEvent(ISixnetDataCommandStartingEventHandler eventHandler)
        {
        ...
        public void TriggerStartingEvent(SixnetDataCommandStartingEvent dataCommandStartingEvent)
        {
        ...
        /// </summary>
        /// <param name="eventHandler">Event handler</param>
        public void SubscribeCallbackEvent(ISixnetDataCommandCallbackEventHandler eventHandler)
        {
            if (eventHandler != null)
            {
        ...
        public void TriggerCallbackEvent(SixnetDataCommandCallbackEvent dataCommandCallbackEvent)
        {
        ...
        void ResetIdentityValues()
        {
            ...
            {
                var primaryFields = SixnetEntityManager.GetPrimaryKeyNames(EntityType);
