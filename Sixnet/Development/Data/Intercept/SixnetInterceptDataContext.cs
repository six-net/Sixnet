...
namespace Sixnet.Development.Data.Intercept
{
    ...
    /// </summary>
    public class SixnetInterceptDataContext
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public SixnetDataOperationType GetDataOperationType()
        {
        ...
        internal bool AllowUpdateNewValue(Type valueType, string fieldName)
        {
            ...
            return !(value is ISixnetField dataField
                && (dataField is not SixnetConstantField constantField || !constantField.IsSimpleConstant));
        }
    }
}
