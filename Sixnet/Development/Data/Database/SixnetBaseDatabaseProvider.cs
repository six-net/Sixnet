...
namespace Sixnet.Development.Data.Database
{
    ...
    /// </summary>
    public abstract partial class SixnetBaseDatabaseProvider : ISixnetDatabaseProvider
    {
        #region Fields
        ...
        /// <returns></returns>
        public abstract SixnetDatabaseConnectionMeta GetDbConnectionMeta(IDbConnection connection);
        ...
        public virtual int Execute(SixnetMultipleDatabaseCommand command)
        {
            try
            {
        ...
        /// <returns></returns>
        protected virtual int ExecuteDatabaseStatement(SixnetDatabaseCommand command, SixnetExecutionDatabaseStatement statement)
        {
        ...
        public virtual Dictionary<string, TIdentity> InsertAndReturnIdentity<TIdentity>(SixnetMultipleDatabaseCommand command)
        {
            try
            {
                var dataCommandResolver = GetDataCommandResolver();
        ...
        public abstract void BulkInsert(SixnetBulkInsertDatabaseCommand command);
        ...
        /// <returns></returns>
        public virtual void Migrate(SixnetMigrationDatabaseCommand command)
        {
            try
            {
                var dataCommandResolver = GetDataCommandResolver();
        ...
        /// <param name="command">Command</param>
        /// <returns></returns>
        public virtual List<SixnetDatabase> GetDatabases(SixnetDatabaseCommand command)
        {
