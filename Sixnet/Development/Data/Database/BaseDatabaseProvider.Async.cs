...
namespace Sixnet.Development.Data.Database
{
    ...
    /// </summary>
    public abstract partial class BaseDatabaseProvider
    {
        #region Execution
        ...
        public virtual async Task<int> ExecuteAsync(DatabaseMultipleCommand command)
        {
        ...
        /// <returns></returns>
        async Task<int> ExecuteDatabaseStatementAsync(DatabaseCommand command, DatabaseExecutionStatement statement)
        {
        ...
        public virtual async Task<List<T>> QueryAsync<T>(DatabaseSingleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
        ...
        /// <param name="command">Database single command</param>
        /// <returns>Return the datas</returns>
        public virtual async Task<T> QueryFirstAsync<T>(DatabaseSingleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        /// <returns>Return the datas</returns>
        public virtual async Task<List<TReturn>> QueryMappingAsync<TFirst, TSecond, TReturn>(DatabaseQueryMappingCommand<TFirst, TSecond, TReturn> command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        /// <param name="command">Database single command</param>
        /// <returns>Return the datas</returns>
        public virtual async Task<PagingInfo<T>> QueryPagingAsync<T>(DatabaseSingleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            ...
            var pagingDatas = (await command.Connection.DbConnection.QueryAsync<PagingTotalCountModel, T, PagingTotalCountMappingModel<T>>(GetCommandDefinition(command, queryStatement)
                               , PagingTotalCountMappingModel<T>.PagingTotalCountMappingFunc, DataManager.PagingTotalCountSplitFieldName).ConfigureAwait(false)
            ...
            return Pager.Create(pagingFilter.Page, pagingFilter.PageSize, firstData.PagingTotalDataCount, pagingDatas.Select(c => c.RealReturnData));
        }
        ...
        public virtual async Task<bool> ExistsAsync(DatabaseSingleCommand command)
        {
        ...
        /// <param name="command">Database single command</param>
        /// <returns></returns>
        public virtual async Task<int> CountAsync(DatabaseSingleCommand command)
        {
        ...
        public virtual async Task<T> ScalarAsync<T>(DatabaseSingleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        public virtual async Task<DataSet> QueryMultipleAsync(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual async Task<Tuple<List<TFirst>, List<TSecond>>> QueryMultipleAsync<TFirst, TSecond>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual async Task<Tuple<List<TFirst>, List<TSecond>, List<TThird>>> QueryMultipleAsync<TFirst, TSecond, TThird>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = await command.Connection.DbConnection.QueryMultipleAsync(GetCommandDefinition(command, queryStatement)).ConfigureAwait(false))
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual async Task<Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>>> QueryMultipleAsync<TFirst, TSecond, TThird, TFourth>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = await command.Connection.DbConnection.QueryMultipleAsync(GetCommandDefinition(command, queryStatement)).ConfigureAwait(false))
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual async Task<Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>>> QueryMultipleAsync<TFirst, TSecond, TThird, TFourth, TFifth>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = await command.Connection.DbConnection.QueryMultipleAsync(GetCommandDefinition(command, queryStatement)).ConfigureAwait(false))
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual async Task<Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>, List<TSixth>>> QueryMultipleAsync<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = await command.Connection.DbConnection.QueryMultipleAsync(GetCommandDefinition(command, queryStatement)).ConfigureAwait(false))
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual async Task<Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>, List<TSixth>, List<TSeventh>>> QueryMultipleAsync<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = await command.Connection.DbConnection.QueryMultipleAsync(GetCommandDefinition(command, queryStatement)).ConfigureAwait(false))
        ...
        public virtual async Task<Dictionary<string, TIdentity>> InsertAndReturnIdentityAsync<TIdentity>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var statements = dataCommandResolver.GenerateDatabaseExecutionStatements(command);
        ...
        public abstract Task BulkInsertAsync(DatabaseBulkInsertCommand command);
        ...
        /// <returns></returns>
        public virtual async Task MigrateAsync(DatabaseMigrationCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
        ...
        /// <param name="command">Command</param>
        /// <returns></returns>
        public virtual async Task<List<DatabaseTableInfo>> GetTablesAsync(DatabaseCommand command)
        {
            return (await command.Connection.DbConnection.QueryAsync<DatabaseTableInfo>(queryDatabaseTablesScript, transaction: command.Connection?.Transaction?.DbTransaction).ConfigureAwait(false)).ToList();
        }
