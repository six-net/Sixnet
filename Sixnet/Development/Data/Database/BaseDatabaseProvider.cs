...
namespace Sixnet.Development.Data.Database
{
    ...
    /// </summary>
    public abstract partial class BaseDatabaseProvider : IDatabaseProvider
    {
        #region Fields
        ...
        /// </summary>
        /// <returns></returns>
        protected abstract IDataCommandResolver GetDataCommandResolver();
        ...
        public virtual int Execute(DatabaseMultipleCommand command)
        {
        ...
        /// <returns></returns>
        protected virtual int ExecuteDatabaseStatement(DatabaseCommand command, DatabaseExecutionStatement statement)
        {
        ...
        public virtual List<T> Query<T>(DatabaseSingleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
        ...
        /// <param name="command">Database single command</param>
        /// <returns>Return the datas</returns>
        public virtual T QueryFirst<T>(DatabaseSingleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        /// <returns>Return the datas</returns>
        public virtual List<TReturn> QueryMapping<TFirst, TSecond, TReturn>(DatabaseQueryMappingCommand<TFirst, TSecond, TReturn> command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        /// <param name="command">Database single command</param>
        /// <returns>Return the datas</returns>
        public virtual PagingInfo<T> QueryPaging<T>(DatabaseSingleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            ...
            var pagingDatas = command.Connection.DbConnection.Query<PagingTotalCountModel, T, PagingTotalCountMappingModel<T>>(queryStatement.Script, PagingTotalCountMappingModel<T>.PagingTotalCountMappingFunc
                , param: ConvertDataCommandParameters(queryStatement.Parameters)
                , transaction: command.Connection?.Transaction?.DbTransaction
                , splitOn: DataManager.PagingTotalCountSplitFieldName
                , commandType: queryStatement.ScriptType)
        ...
        public virtual bool Exists(DatabaseSingleCommand command)
        {
        ...
        /// <param name="command">Database single command</param>
        /// <returns></returns>
        public int Count(DatabaseSingleCommand command)
        {
        ...
        public virtual T Scalar<T>(DatabaseSingleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        public virtual DataSet QueryMultiple(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual Tuple<List<TFirst>, List<TSecond>> QueryMultiple<TFirst, TSecond>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual Tuple<List<TFirst>, List<TSecond>, List<TThird>> QueryMultiple<TFirst, TSecond, TThird>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = command.Connection.DbConnection.QueryMultiple(GetCommandDefinition(command, queryStatement)))
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>> QueryMultiple<TFirst, TSecond, TThird, TFourth>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = command.Connection.DbConnection.QueryMultiple(GetCommandDefinition(command, queryStatement)))
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>> QueryMultiple<TFirst, TSecond, TThird, TFourth, TFifth>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = command.Connection.DbConnection.QueryMultiple(GetCommandDefinition(command, queryStatement)))
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>, List<TSixth>> QueryMultiple<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = command.Connection.DbConnection.QueryMultiple(GetCommandDefinition(command, queryStatement)))
        ...
        /// <param name="command">Database multiple command</param>
        /// <returns></returns>
        public virtual Tuple<List<TFirst>, List<TSecond>, List<TThird>, List<TFourth>, List<TFifth>, List<TSixth>, List<TSeventh>> QueryMultiple<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var queryStatement = dataCommandResolver.GenerateDatabaseQueryStatement(command);
            using (var gridReader = command.Connection.DbConnection.QueryMultiple(GetCommandDefinition(command, queryStatement)))
        ...
        public virtual Dictionary<string, TIdentity> InsertAndReturnIdentity<TIdentity>(DatabaseMultipleCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
            var statements = dataCommandResolver.GenerateDatabaseExecutionStatements(command);
        ...
        public abstract void BulkInsert(DatabaseBulkInsertCommand command);
        ...
        /// <returns></returns>
        public virtual void Migrate(DatabaseMigrationCommand command)
        {
            var dataCommandResolver = GetDataCommandResolver();
        ...
        /// <param name="command">Command</param>
        /// <returns></returns>
        public virtual List<DatabaseTableInfo> GetTables(DatabaseCommand command)
        {
            return command.Connection.DbConnection.Query<DatabaseTableInfo>(queryDatabaseTablesScript, transaction: command.Connection?.Transaction?.DbTransaction).ToList();
        }
