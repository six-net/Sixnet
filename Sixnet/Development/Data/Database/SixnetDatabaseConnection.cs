...
namespace Sixnet.Development.Data.Database
{
    ...
    public class SixnetDatabaseConnection
    {
        ...
        /// </summary>
        public SixnetDataIsolationLevel? DataIsolationLevel { get; set; }
        ...
        /// </summary>
        private SixnetLockInstance? ConnectionLock { get; set; }
        ...
        private SixnetDatabaseConnection(SixnetDatabaseServer databaseServer, bool useTransaction, SixnetDataIsolationLevel? isolationLevel = null, SixnetLockInstance? connLock = null)
        {
        ...
        /// <param name="isolationLevel">Isolation level</param>
        /// <returns></returns>
        public static SixnetDatabaseConnection Create(SixnetDatabaseServer server, bool useTransaction, SixnetDataIsolationLevel? isolationLevel = null)
        {
