...
namespace Sixnet.Development.Queryable
{
    ...
    /// </summary>
    [Serializable]
    public class SixnetQueryableTranslationResult
    {
        #region Constructor

        private SixnetQueryableTranslationResult() { }
        ...
        /// <returns></returns>
        public static SixnetQueryableTranslationResult Create(ISixnetQueryable originalQuery)
        {
            return new SixnetQueryableTranslationResult()
            {
        ...
        /// </summary>
        public static SixnetQueryableTranslationResult Empty => Create(null);
        ...
        /// <returns></returns>
        public SixnetQueryableTranslationResult AddCondition(string newConditionString, string connector)
        {
        ...
        /// <returns></returns>
        public SixnetQueryableTranslationResult Negate(Func<string, string> negationFunc)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public SixnetQueryableTranslationResult ClearCondition()
        {
            conditions?.Clear();
            return this;
        }
        ...
        /// <returns></returns>
        public SixnetQueryableTranslationResult SetJoin(string joinScript)
        {
            join = joinScript;
            return this;
        }
        ...
        /// <returns></returns>
        public SixnetQueryableTranslationResult SetJoinConnection(string joinConnection)
        {
        ...
        /// <returns></returns>
        public SixnetQueryableTranslationResult SetHavingCondition(string havingCondition)
        {
        ...
        /// <returns></returns>
        public SixnetQueryableTranslationResult SetSort(string sort, string sortStatementStartKeyword)
        {
        ...
        /// <returns></returns>
        public SixnetQueryableTranslationResult SetCombine(string combine)
        {
        ...
        /// <returns></returns>
        public SixnetQueryableTranslationResult SetGroup(string group)
        {
            this.group = group;
            return this;
        }
        ...
        /// <returns></returns>
        public SixnetQueryableTranslationResult SetPreOutput(string statement, IEnumerable<ISixnetField> fields = null)
        {
            preOutput = statement;
