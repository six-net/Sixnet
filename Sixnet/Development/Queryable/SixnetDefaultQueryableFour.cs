...
namespace Sixnet.Development.Queryable
{
    ...
    internal partial class SixnetDefaultQueryableFour<TFirst, TSecond, TThird, TFourth> : SixnetDefaultQueryableThree<TFirst, TSecond, TThird>, ISixnetQueryable<TFirst, TSecond, TThird, TFourth>
    {
        ...
        public SixnetDefaultQueryableFour(SixnetQueryableContext sourceQueryableContext) : base(sourceQueryableContext) { }
        ...
        {
            return new SixnetDefaultQueryableFour<TFirst, TSecond, TThird, TFourth>(queryableContext?.LightClone());
        }

        protected override ISixnetQueryable CloneCore()
        {
            return new SixnetDefaultQueryableFour<TFirst, TSecond, TThird, TFourth>(queryableContext?.Clone());
        }
        ...
        /// <returns></returns>
        public new ISixnetQueryable<TFirst, TSecond, TThird, TFourth> SpecifySplitTable(params string[] tableNames)
        {
