...
namespace Sixnet.Development.Message
{
    ...
    public static class MessageManager
    {
        ...
        public static async Task<SendMessageResult> CommitAsync(bool asynchronously = true)
        {
            ...
            if (asynchronously)
            {
                var messageInternalCommand = new InternalQueueMessageItem(MessageProvider, currentMessages, UnitOfWork.Current);
                InternalQueueManager.GetQueue(InternalQueueNames.Message).Enqueue(messageInternalCommand);
