...
namespace Sixnet.Development.Repository
{
    ...
    public abstract partial class BaseRepository<TModel> : ISixnetRepository<TModel>
    {
        ...
        /// <param name="configure">Confirure options </param>
        /// <returns>Value</returns>
        public abstract TValue Scalar<TValue>(PropertyField field, Action<DataOperationOptions> configure = null);
        ...
        /// <param name="configure">Confirure options </param>
        /// <returns>Value</returns>
        public abstract TValue Scalar<TValue>(PropertyField field, Expression<Func<TModel, bool>> conditionExpression, Action<DataOperationOptions> configure = null);
