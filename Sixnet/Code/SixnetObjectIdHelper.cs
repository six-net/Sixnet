...
namespace Sixnet.Code
{
    ...
    public static class SixnetObjectIdHelper
    {
        ...
        public static void InitAppObjectIds()
        {
            ...
            {
                var generadeIdFields = entityConfig.AllFields?.Where(c => c.Value.InRole(SixnetFieldRole.GeneratedId)).ToList();
                ...
                foreach (var fieldItem in generadeIdFields)
                {
                    ...
                    var dataField = SixnetDataField.Create(field.PropertyName, entityConfig.EntityType, 0, null, field.FieldName);
