...
namespace Sixnet.Code
{
    ...
    /// </summary>
    public static class SixnetSerialNumber
    {
        #region Fields
        ...
        /// Generator groups
        /// </summary>
        static readonly Dictionary<string, SixnetSnowflakeNet> _generatorGroups = new();

        /// <summary>
        /// Default generator
        /// </summary>
        static readonly SixnetSnowflakeNet _defaultGenerator = new(1, 1);
        ...
        public static void AddGenerator(IEnumerable<string> groups, long dataCenterId, long workerId, long sequence = 0L, DateTimeOffset? startDate = null)
        {
            ...
            foreach (string group in groups)
            {
                ...
                {
                    _generatorGroups.Add(group, new SixnetSnowflakeNet(dataCenterId, workerId, sequence, startDate));
                }
            }
        }
