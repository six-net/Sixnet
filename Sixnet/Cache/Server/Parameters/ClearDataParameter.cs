...
namespace Sixnet.Cache.Server.Parameters
{
    ...
    /// </summary>
    public class ClearDataParameter : CacheParameter<ClearDataResult>
    {
        ///// <summary>
        ...
        protected override async Task<ClearDataResult> ExecuteCacheOperationAsync(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
        ...
        /// <param name="server">Cache server</param>
        /// <returns>Return clear data response</returns>
        protected override ClearDataResult ExecuteCacheOperation(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
