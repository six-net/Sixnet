...
namespace Sixnet.Cache.SortedSet.Parameters
{
    ...
    /// </summary>
    public class SortedSetRangeByScoreWithScoresParameter : CacheParameter<SortedSetRangeByScoreWithScoresResult>
    {
        /// <summary>
        ...
        protected override async Task<SortedSetRangeByScoreWithScoresResult> ExecuteCacheOperationAsync(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
        ...
        /// <param name="server">Cache server</param>
        /// <returns>Return sorted set range by score with scores response</returns>
        protected override SortedSetRangeByScoreWithScoresResult ExecuteCacheOperation(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
