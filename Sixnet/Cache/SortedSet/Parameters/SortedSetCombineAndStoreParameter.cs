...
namespace Sixnet.Cache.SortedSet.Parameters
{
    ...
    /// </summary>
    public class SortedSetCombineAndStoreParameter : CacheParameter<SortedSetCombineAndStoreResult>
    {
        /// <summary>
        ...
        protected override async Task<SortedSetCombineAndStoreResult> ExecuteCacheOperationAsync(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
        ...
        /// <param name="server">Cache server</param>
        /// <returns>Return sorted set combine and store response</returns>
        protected override SortedSetCombineAndStoreResult ExecuteCacheOperation(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
