...
namespace Sixnet.Cache.SortedSet.Parameters
{
    ...
    /// </summary>
    public class SortedSetRangeByValueParameter : CacheParameter<SortedSetRangeByValueResult>
    {
        /// <summary>
        ...
        protected override async Task<SortedSetRangeByValueResult> ExecuteCacheOperationAsync(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
        ...
        /// <param name="server">Cache server</param>
        /// <returns>Return sorted set range by value response</returns>
        protected override SortedSetRangeByValueResult ExecuteCacheOperation(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
