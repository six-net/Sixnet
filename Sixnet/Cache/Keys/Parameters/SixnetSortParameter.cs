...
namespace Sixnet.Cache.Keys.Parameters
{
    ...
    /// Sort parameter
    /// </summary>
    public class SixnetSortParameter : SixnetCacheParameter<SixnetSortResult>
    {
        /// <summary>
        ...
        protected override async Task<SixnetSortResult> ExecuteCacheOperationAsync(ISixnetCacheProvider cacheProvider, SixnetCacheServer server)
        {
        ...
        /// <param name="server">Cache server</param>
        /// <returns>Return sort response</returns>
        protected override SixnetSortResult ExecuteCacheOperation(ISixnetCacheProvider cacheProvider, SixnetCacheServer server)
        {
