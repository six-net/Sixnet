...
namespace Sixnet.Cache.Keys.Parameters
{
    ...
    /// </summary>
    public class SortAndStoreParameter : CacheParameter<SortAndStoreResult>
    {
        /// <summary>
        ...
        protected override async Task<SortAndStoreResult> ExecuteCacheOperationAsync(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
        ...
        /// <param name="server">Cache server</param>
        /// <returns>Return sort and store response</returns>
        protected override SortAndStoreResult ExecuteCacheOperation(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
