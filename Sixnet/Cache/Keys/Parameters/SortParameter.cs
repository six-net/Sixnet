...
namespace Sixnet.Cache.Keys.Parameters
{
    ...
    /// Sort parameter
    /// </summary>
    public class SortParameter : CacheParameter<SortResult>
    {
        /// <summary>
        ...
        protected override async Task<SortResult> ExecuteCacheOperationAsync(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
        ...
        /// <param name="server">Cache server</param>
        /// <returns>Return sort response</returns>
        protected override SortResult ExecuteCacheOperation(ISixnetCacheProvider cacheProvider, CacheServer server)
        {
