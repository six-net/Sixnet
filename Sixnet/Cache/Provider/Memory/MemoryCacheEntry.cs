...
namespace Sixnet.Cache.Provider.Memory
{
    internal class MemoryCacheEntry : ICacheEntry
    {
        ...
        private static void ExpirationTokensExpired(object obj)
        {
            ...
            {
                var entry = (MemoryCacheEntry)state;
        ...
        internal void InvokeEvictionCallbacks()
        {
            if (_postEvictionCallbacks != null)
            {
                Task.Factory.StartNew(state => InvokeCallbacks((MemoryCacheEntry)state), this,
        ...
        internal void PropagateOptions(MemoryCacheEntry parent)
        {
            if (parent == null)
            {
                return;
