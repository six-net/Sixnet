...
namespace Sixnet.Cache
{
    ...
    /// Cache key
    /// </summary>
    public class SixnetCacheKey
    {
        /// <summary>
        /// Create cache key
        /// </summary>
        /// <param name="previousKeys">Previous keys</param>
        public SixnetCacheKey(params SixnetCacheKey[] previousKeys) : this(null, previousKeys)
        {
        }
        ...
        /// <param name="previousKeys">Previous keys</param>
        public SixnetCacheKey(SixnetCacheObject cacheObject, params SixnetCacheKey[] previousKeys) : this(cacheObject, (IEnumerable<SixnetCacheKey>)previousKeys)
        {
        }
        ...
        public SixnetCacheKey(IEnumerable<SixnetCacheKey> previousKeys) : this(null, previousKeys)
        {
        }
        ...
        /// <param name="cacheObject">Cache object</param>
        /// <param name="previousKeys">Previous keys</param>
        public SixnetCacheKey(SixnetCacheObject cacheObject, IEnumerable<SixnetCacheKey> previousKeys)
        {
        ...
        public SixnetCacheKey(string name, string value = "") : this(null, name, value)
        {
        }
        ...
        /// <param name="name">Name</param>
        /// <param name="value">Value</param>
        public SixnetCacheKey(SixnetCacheObject cacheObject, string name, string value = "")
        {
            this.cacheObject = cacheObject;
            AddName(name, value);
        }
        ...
        /// Cache object
        /// </summary>
        protected SixnetCacheObject cacheObject = null;
        ...
        public SixnetCacheKey AddName(string name, string value = "")
        {
        ...
        public static implicit operator string(SixnetCacheKey cacheKey)
        {
        ...
        public static implicit operator SixnetCacheKey(string key)
        {
            var cacheKey = new SixnetCacheKey();
        ...
        {
            var targetObj = obj as SixnetCacheKey;
    ...
    /// Constant cache key
    /// </summary>
    public class ConstantCacheKey : SixnetCacheKey
    {
        /// <summary>
