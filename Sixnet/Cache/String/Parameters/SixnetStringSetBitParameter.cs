...
namespace Sixnet.Cache.String.Parameters
{
    ...
    /// </summary>
    public class SixnetStringSetBitParameter : SixnetCacheParameter<SixnetStringSetBitResult>
    {
        /// <summary>
        ...
        protected override async Task<SixnetStringSetBitResult> ExecuteCacheOperationAsync(ISixnetCacheProvider cacheProvider, SixnetCacheServer server)
        {
        ...
        /// <param name="server">Cache server</param>
        /// <returns>Return string bit response</returns>
        protected override SixnetStringSetBitResult ExecuteCacheOperation(ISixnetCacheProvider cacheProvider, SixnetCacheServer server)
        {
