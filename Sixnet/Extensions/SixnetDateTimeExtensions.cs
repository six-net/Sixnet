...
namespace System
{
    ...
    /// </summary>
    public static class SixnetDateTimeExtensions
    {
        internal static readonly CultureInfo chineseCultureInfo = new("zh-CN");
        ...
        public static SixnetConstellation GetConstellation(this DateTime date)
        {
    ...
    public static class DateTimeOffsetExtension
    {
        ...
        {
            return dateTime.ToString("yyyy年MM月dd日 dddd", SixnetDateTimeExtensions.chineseCultureInfo); ;
        }
        ...
        /// <param name="date">Date</param>
        /// <returns>Return the constellation</returns>
        public static SixnetConstellation GetConstellation(this DateTimeOffset date)
        {
            var constellDate = new DateTimeOffset(2000, date.Month, date.Day, 0, 0, 0, SixnetTimes.Zero);
            return SixnetTimes.Constellations.FirstOrDefault(c => c.Value.Item1 <= constellDate && c.Value.Item2 >= constellDate).Key;
        }
