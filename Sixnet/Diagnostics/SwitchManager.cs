...
namespace Sixnet.Diagnostics
{
    ...
    public static class SwitchManager
    {
        ...
        {
            AddSwitch(SwitchNames.FrameworkTraceLog, nameof(TraceEventType.Verbose));
        }
        ...
        {
            RemoveSwitch(SwitchNames.FrameworkTraceLog);
        }
        ...
        public static bool ShouldTraceFramework(Action<Switch> listenAction = null)
        {
            ...
            {
                AddSwitchListener(SwitchNames.FrameworkTraceLog, listenAction);
            }
            return ShouldTrace(SwitchNames.FrameworkTraceLog, TraceEventType.Verbose);
        }
