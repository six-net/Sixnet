...
namespace Sixnet.Algorithm.Selection
{
    ...
    /// </summary>
    [Serializable]
    public class SixnetShuffleNet<T>
    {
        readonly IEnumerable<T> originalValues;
        T[] valueArray;
        int lastIndex = 0;
        ...
        /// <summary>
        /// Initializes a new instance of the Sixnet.Algorithm.Selection.SixnetShuffleNet class
        /// </summary>
        ...
        public SixnetShuffleNet(IEnumerable<T> originalValues, bool derange = true, bool loop = false)
        {
