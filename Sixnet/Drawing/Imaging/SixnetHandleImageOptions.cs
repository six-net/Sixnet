...
namespace Sixnet.Drawing.Imaging
{
    ...
    /// </summary>
    public class SixnetHandleImageOptions
    {
        /// <summary>
        ...
        /// </summary>
        public SixnetScalingType ScalingType { get; set; } = SixnetScalingType.Regular;

        /// <summary>
        /// Indecates whether sacling quality
        /// </summary>
        public SixnetScalingQuality ScalingQuality { get; set; } = SixnetScalingQuality.Default;
