...
namespace Sixnet.Drawing.Imaging
{
    ...
    /// Split image options
    /// </summary>
    public class SixnetSplitImageOptions
    {
        /// <summary>
        /// Gets or sets the image handling options action
        /// </summary>
        public Action<SixnetHandleImageOptions> ImageHandlingOptionsAction { get; set; }
        ...
        /// </summary>
        public SixnetImageSplitDirection Direction { get; set; }
