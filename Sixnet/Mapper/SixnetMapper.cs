...
namespace Sixnet.Mapper
{
    ...
    /// Sixnet mapper
    /// </summary>
    public static class SixnetMapper
    {
        /// <summary>
        ...
        /// </summary>
        public static ISixnetMapper Current { get; internal set; }
        ...
        /// </summary>
        /// <returns></returns>
        public static ISixnetMapper BuildMapper()
        {
            if (Current == null || Current is ConventionMapper)
            {
                var mapperBuilder = SixnetApplication.Options.MapperBuilder;
        ...
        public static void SetMapper(ISixnetMapper mapper)
        {
            if (mapper == null)
            {
