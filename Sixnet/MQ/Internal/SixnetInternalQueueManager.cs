...
namespace Sixnet.MQ.Internal
{
    ...
    /// </summary>
    internal static class SixnetInternalQueueManager
    {
        /// <summary>
        /// Queues
        /// </summary>
        static readonly ConcurrentDictionary<string, SixnetInternalQueue> _queues = new();
        ...
        public static void AddQueue(string name)
        {
            if (!_queues.ContainsKey(name))
            {
                ...
                try
                {
                    if (!_queues.ContainsKey(name))
                    {
                        var newQueue = SixnetInternalQueue.Create(name);
        ...
        public static SixnetInternalQueue GetQueue(string name)
        {
