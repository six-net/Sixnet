...
namespace System
{
    ...
    public static class SixnetValidationExtensions
    {
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.Integer.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.PositiveInteger.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.NegativeInteger.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.PositiveIntegerOrZero.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.NegativeIntegerOrZero.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.Fraction.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.PositiveFraction.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.NegativeFraction.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.PositiveFractionOrZero.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.NegativeFractionOrZero.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.Number.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.Color.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.ContainsChinese.IsMatch(value);
        }
        ...
        {
            return SixnetSixnetRegexConstants.ContainsChinese.IsMatch(value.ToString());
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.AllChinese.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.PostCode.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.Mobile.IsMatch(value) && value.Length == 11;
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.IPV4.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.Date.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.DateTime.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.QQ.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.Letter.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.UpperLetter.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.LowerLetter.IsMatch(value);
        }
        ...
        {
            return !string.IsNullOrEmpty(value) && SixnetSixnetRegexConstants.IdentityCard.IsMatch(value);
        }
        ...
        /// <summary>
        /// Verify whether is enum
        /// </summary>
        /// <param name="value">Value</param>
        /// <param name="enumType">enum type</param>
        /// <returns>Return whether the verification has passed</returns>
        public static bool IsEnum(this object value, Type enumType)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Return whether the verification has passed</returns>
        public static bool IsEnum<TEnum>(this object value)
        {
            return IsEnum(value, typeof(TEnum));
        }
