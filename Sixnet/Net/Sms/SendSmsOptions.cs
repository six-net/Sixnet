...
namespace Sixnet.Net.Sms
{
    ...
    public class SendSmsOptions : SmsOptions
    {
        ...
        /// <summary>
        /// Gets or sets the send callback
        /// Return a boolean value indecates send sms continue
        /// </summary>
        public Action<SendSmsResult> OnAsyncCallback { get; set; }
        ...
        public override SmsOptions Clone()
        {
            return new SendSmsOptions()
            {
                ...
                OnAsyncBeforeSend = OnAsyncBeforeSend,
            };
        }
    }
}
