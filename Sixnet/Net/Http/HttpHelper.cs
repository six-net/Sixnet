...
namespace Sixnet.Net.Http
{
    ...
    public static partial class HttpHelper
    {
        ...
        public static UploadResult PostUpload(string httpClientConfigName, string url, IDictionary<string, byte[]> files, IDictionary<string, string> parameters = null, IDictionary<string, string> headers = null, string token = "")
        {
        ...
        /// <param name="token">Token</param>
        /// <returns>Return upload result</returns>
        public static UploadResult PostUpload(string url, IDictionary<string, byte[]> files, IDictionary<string, string> parameters = null, IDictionary<string, string> headers = null, string token = "")
        {
            return PostUpload(string.Empty, url, files, parameters, headers, token);
        }
        ...
        /// <param name="token">Token</param>
        /// <returns>Return upload result</returns>
        public static UploadResult PostUpload(string httpClientConfigName, string url, byte[] file, object parameters, IDictionary<string, string> headers = null, string token = "")
        {
            ...
            return PostUpload(httpClientConfigName, url, new Dictionary<string, byte[]>() { { "file1", file } }, parameterDict, headers, token);
        }
        ...
        /// <param name="token">Token</param>
        /// <returns>Return upload result</returns>
        public static UploadResult PostUpload(string url, byte[] file, object parameters, IDictionary<string, string> headers = null, string token = "")
        {
            return PostUpload(string.Empty, url, file, parameters, headers, token);
        }
