...
using Sixnet.DataValidation.Configuration;
using Sixnet.DataValidation.Validators;
...
namespace Sixnet.DataValidation
{
    ...
    public static class ValidationManager
    {
        ...
        static void SetValidation<T>(DataValidator validator, params ValidationField<T>[] fields)
        {
            ...
            {
                var propertyName = ExpressionHelper.GetExpressionText(property.Field);
        ...
        /// <param name="field">Field</param>
        /// <returns></returns>
        public static IValidationRule<T> For<T>(Expression<Func<T, dynamic>> field)
        {
            return ValidationRule<T>.Create(field);
        }
        ...
        public static List<VerifyResult> Validate<T>(T obj, string useScenario = "")
        {
            ...
            var validationList = TypeValidations[typeName];
            var resultList = new List<VerifyResult>();
