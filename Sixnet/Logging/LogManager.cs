...
namespace Sixnet.Logging
{
    ...
    public static class LogManager
    {
        ...
        static void WriteLog(Type categoryType, LogLevel level, EventId eventId, Exception exception, string message, params object[] args)
        {
            WriteLog(categoryType?.FullName ?? string.Empty, level, eventId, exception, message, args);
        }
        ...
        {
            var writeLogCommand = new LogInternalQueueTask()
            {
            ...
            InternalQueueManager.GetQueue(InternalQueueNames.Logging).Enqueue(writeLogCommand);
        }
