...
namespace Sixnet.Logging
{
    ...
    /// </summary>
    public static class SixnetFrameworkLogManager
    {
        #region Fields
        ...
        static SixnetFrameworkLogManager()
        {
        ...
        public static void LogDatabaseScript(Type databaseProviderType, SixnetDatabaseType databaseType, string script, object parameters)
        {
        ...
        public static void LogDatabaseExecutionStatement(Type databaseProviderType, SixnetDatabaseType databaseType, SixnetExecutionDatabaseStatement statement)
        {
