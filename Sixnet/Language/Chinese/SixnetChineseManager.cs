...
namespace Sixnet.Language.Chinese
{
    ...
    /// Chinese manager
    /// </summary>
    public static class SixnetChineseManager
    {
        ...
        public static ISixnetChineseProvider GetChineseProvider()
        {
            return SixnetContainer.GetService<ISixnetChineseProvider>();
        }
        ...
        /// </summary>
        /// <returns>Return chinese provider</returns>
        static ISixnetChineseProvider GetChineseProviderThrowIfNull()
        {
