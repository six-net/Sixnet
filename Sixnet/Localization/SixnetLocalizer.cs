...
namespace Sixnet.Localization
{
    ...
    public static class SixnetLocalizer
    {
        ...
        /// <summary>
        /// Whether localize throw message
        /// </summary>
        /// <returns></returns>
        internal static bool IsLocalizeThrowMessage()
        {
            return SixnetContainer.GetOptions<SixnetLocalizationOptions>()?.AutoLocalizeThrowMessage ?? false;
        }
        ...
        {
            var localizer = SixnetContainer.GetService<ISixnetStringLocalizer>();
            SixnetDirectThrower.ThrowSixnetExceptionIf(localizer == null, "Get sixnet string localizer failed.");
            return localizer;
        }

        /// <summary>
        /// Get sixnet string localizer
        /// </summary>
        ...
        {
            var localizer = SixnetContainer.GetService<ISixnetStringLocalizer<TResourceSource>>();
            SixnetDirectThrower.ThrowSixnetExceptionIf(localizer == null, "Get sixnet string localizer failed.");
            return localizer;
        }
    }
