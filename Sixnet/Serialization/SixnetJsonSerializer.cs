...
using Sixnet.Serialization.Json.Newtonsoft;
...
namespace Sixnet.Serialization
{
    ...
    public static class SixnetJsonSerializer
    {
        ...
        /// </summary>
        private static readonly JsonSerializationOptions ResolveNonPublicOptions = new() { ResolveNonPublic = true };
        ...
        static SixnetJsonSerializer()
        {
            JsonSerializationProvider = SixnetContainer.GetService<IJsonSerializationProvider>();
