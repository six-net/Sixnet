...
namespace Sixnet.Component.Retry
{
    ...
    /// Retry pipeline
    /// </summary>
    internal class SixnetRetryPipeline
    {
        /// <summary>
        ...
        /// Before retry
        /// </summary>
        public Action<SixnetRetryContext> OnBeforeRetry { get; set; }
        ...
        public void Execute()
        {
            ...
            var retriedTimes = 0;
            var ctx = new SixnetRetryContext();
            do
            {
                try
                {
    ...
    /// Retry pipeline
    /// </summary>
    internal class SixnetRetryPipeline<T>
    {
        /// <summary>
        ...
        /// </summary>
        public Func<SixnetRetryContext, bool> When { get; set; }
