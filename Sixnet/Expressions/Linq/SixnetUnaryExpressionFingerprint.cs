...
namespace Sixnet.Expressions.Linq
{
    ...
    public sealed class SixnetUnaryExpressionFingerprint : SixnetExpressionFingerprint
    {
        public SixnetUnaryExpressionFingerprint(ExpressionType nodeType, Type type, MethodInfo method)
            : base(nodeType, type)
        {
        ...
        {
            SixnetUnaryExpressionFingerprint other = obj as SixnetUnaryExpressionFingerprint;
            return other != null
