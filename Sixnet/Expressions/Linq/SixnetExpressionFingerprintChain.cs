...
namespace Sixnet.Expressions.Linq
{
    ...
    public sealed class SixnetExpressionFingerprintChain : IEquatable<SixnetExpressionFingerprintChain>
    {
        public readonly List<SixnetExpressionFingerprint> Elements = new List<SixnetExpressionFingerprint>();

        public bool Equals(SixnetExpressionFingerprintChain other)
        {
        ...
        {
            return Equals(obj as SixnetExpressionFingerprintChain);
        }
