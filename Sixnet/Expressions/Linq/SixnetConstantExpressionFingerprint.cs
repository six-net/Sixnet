...
namespace Sixnet.Expressions.Linq
{
    ...
    public sealed class SixnetConstantExpressionFingerprint : SixnetExpressionFingerprint
    {
        public SixnetConstantExpressionFingerprint(ExpressionType nodeType, Type type)
            : base(nodeType, type)
        {
        ...
        {
            SixnetConstantExpressionFingerprint other = obj as SixnetConstantExpressionFingerprint;
            return other != null
                   && Equals(other);
        }
    }
