...
{
    public static class SixnetCachedExpressionCompiler
    {
        ...
        private static class Compiler<TIn, TOut>
        {
            ...
            private static readonly ConcurrentDictionary<SixnetExpressionFingerprintChain, SixnetHoisted<TIn, TOut>> _fingerprintedCache =
                new ConcurrentDictionary<SixnetExpressionFingerprintChain, SixnetHoisted<TIn, TOut>>();
            ...
            private static Func<TIn, TOut> CompileFromFingerprint(Expression<Func<TIn, TOut>> expr)
            {
                ...
                SixnetExpressionFingerprintChain fingerprint = SixnetFingerprintingExpressionVisitor.GetFingerprintChain(expr, out capturedConstants);
                ...
                if (fingerprint != null)
                {
                    var del = _fingerprintedCache.GetOrAdd(fingerprint, _ =>
                    {
                        ...
                        var hoistedExpr = SixnetHoistingExpressionVisitor<TIn, TOut>.Hoist(expr);
