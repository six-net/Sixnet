...
namespace EZNEW.Develop.DataAccess.Event
{
    ...
    internal class DataAccessEventManager
    {
        ...
        /// <typeparam name="TEvent">Event type</typeparam>
        /// <param name="eventHandleOperation">Event handle operation</param>
        public void Subscribe<TEvent>(Func<TEvent, DataAccessEventExecuteResult> eventHandleOperation) where TEvent : class, IDataAccessEvent
        {
        ...
        /// </summary>
        /// <param name="eventHandleOperation">Event handle operation</param>
        public void SubscribeEntityAll<T>(Func<IDataAccessEvent, DataAccessEventExecuteResult> eventHandleOperation)
        {
            IDataAccessEventHandler domainEventHandler = new DefaultDataAccessEventHandler<IDataAccessEvent>()
            {
                ExecuteEventOperation = eventHandleOperation
