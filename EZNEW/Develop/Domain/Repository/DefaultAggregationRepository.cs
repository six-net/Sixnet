...
namespace EZNEW.Develop.Domain.Repository
{
    ...
    public abstract class DefaultAggregationRepository<TModel, TEntity, TDataAccess> : DefaultAggregationRootRepository<TModel> where TModel : AggregationRoot<TModel> where TEntity : BaseEntity<TEntity>, new() where TDataAccess : IDataAccess<TEntity>
    {
        ...
        {
            return RepositoryManager.AppendRepositoryCondition(entityType, originalQuery, QueryUsageScene.Remove);
        }
        ...
        {
            return RepositoryManager.AppendRepositoryCondition(entityType, originalQuery, QueryUsageScene.Modify);
        }
        ...
        {
            return RepositoryManager.AppendRepositoryCondition(entityType, originalQuery, QueryUsageScene.Query);
        }
        ...
        {
            return RepositoryManager.AppendRepositoryCondition(entityType, originalQuery, QueryUsageScene.Exist);
        }
        ...
        {
            return RepositoryManager.AppendRepositoryCondition(entityType, originalQuery, QueryUsageScene.Count);
        }
        ...
        {
            return RepositoryManager.AppendRepositoryCondition(entityType, originalQuery, QueryUsageScene.Max);
        }
        ...
        {
            return RepositoryManager.AppendRepositoryCondition(entityType, originalQuery, QueryUsageScene.Min);
        }
        ...
        {
            return RepositoryManager.AppendRepositoryCondition(entityType, originalQuery, QueryUsageScene.Sum);
        }
        ...
        {
            return RepositoryManager.AppendRepositoryCondition(entityType, originalQuery, QueryUsageScene.Avg);
        }
