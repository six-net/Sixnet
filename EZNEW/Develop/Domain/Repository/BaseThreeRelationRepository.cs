...
namespace EZNEW.Develop.Domain.Repository
{
    ...
    public abstract class BaseThreeRelationRepository<TFirstModel, TSecondModel, TThirdModel>
    {
        ...
        public abstract void Save(IEnumerable<Tuple<TFirstModel, TSecondModel, TThirdModel>> datas, ActivationOption activationOption = null);
        ...
        /// <param name="datas">Datas</param>
        /// <param name="activationOption">Activation option</param>
        public abstract void SaveByThird(IEnumerable<TThirdModel> datas, ActivationOption activationOption = null);
        ...
        /// <param name="datas">Datas</param>
        /// <param name="activationOption">Activation option</param>
        public abstract void RemoveByThird(IEnumerable<TThirdModel> datas, ActivationOption activationOption = null);
