...
namespace EZNEW.Development.DataAccess.Event
{
    ...
    public static class DataAccessEventBus
    {
        ...
        /// <param name="query">Query</param>
        /// <returns></returns>
        public static void PublishModifyExpressionEvent<T>(Dictionary<string, IModificationValue> modifyValues, IQuery query)
        {
        ...
        /// <param name="query">Query</param>
        /// <returns></returns>
        public static void PublishAggregateFunctionEvent<T>(CommandOperationType operateType, dynamic value, IQuery query)
        {
        ...
        public static void SubscribeAll(Func<IDataAccessEvent, DataAccessEventExecutionResult> eventHandleOperation)
        {
        ...
        /// <typeparam name="TEvent">Event type</typeparam>
        /// <param name="eventHandleOperation">Event handle operation</param>
        public static void Subscribe<TEvent>(Func<TEvent, DataAccessEventExecutionResult> eventHandleOperation) where TEvent : class, IDataAccessEvent
        {
        ...
        /// </summary>
        /// <param name="eventHandleOperation">Event handle operation</param>
        public static void SubscribeEntityAll<T>(Func<IDataAccessEvent, DataAccessEventExecutionResult> eventHandleOperation)
        {
        ...
        /// <typeparam name="TEvent">Event type</typeparam>
        /// <param name="eventHandleOperation">Event handle operation</param>
        public static void SubscribeEntity<TEntity, TEvent>(Func<TEvent, DataAccessEventExecutionResult> eventHandleOperation) where TEvent : class, IDataAccessEvent
        {
        ...
        /// <param name="applyToEntity">Apply to entity</param>
        /// <param name="entityTypes">Entity types</param>
        public static void SubscribeAdd(Func<AddDataEvent, DataAccessEventExecutionResult> eventHandleOperation, bool applyToEntity = false, params Type[] entityTypes)
        {
        ...
        /// <param name="applyToEntity">Apply to entity</param>
        /// <param name="entityTypes">Entity types</param>
        public static void SubscribeUpdate(Func<ModifyDataEvent, DataAccessEventExecutionResult> eventHandleOperation, bool applyToEntity = false, params Type[] entityTypes)
        {
            if (eventHandleOperation == null || (applyToEntity && entityTypes.IsNullOrEmpty()))
            {
                return;
        ...
        /// <param name="applyToEntity">Apply to entity</param>
        /// <param name="entityTypes">Entity types</param>
        public static void SubscribeModifyExpression(Func<ModifyExpressionEvent, DataAccessEventExecutionResult> eventHandleOperation, bool applyToEntity = false, params Type[] entityTypes)
        {
            if (eventHandleOperation == null || (applyToEntity && entityTypes.IsNullOrEmpty()))
            {
                return;
        ...
        /// <param name="applyToEntity">Apply to entity</param>
        /// <param name="entityTypes">Entity types</param>
        public static void SubscribeDelete(Func<DeleteDataEvent, DataAccessEventExecutionResult> eventHandleOperation, bool applyToEntity = false, params Type[] entityTypes)
        {
            if (eventHandleOperation == null || (applyToEntity && entityTypes.IsNullOrEmpty()))
            {
                return;
        ...
        /// <param name="applyToEntity">Apply to entity</param>
        /// <param name="entityTypes">Entity types</param>
        public static void SubscribeDeleteByCondition(Func<DeleteByConditionEvent, DataAccessEventExecutionResult> eventHandleOperation, bool applyToEntity = false, params Type[] entityTypes)
        {
            if (eventHandleOperation == null || (applyToEntity && entityTypes.IsNullOrEmpty()))
            {
                return;
        ...
        /// <param name="applyToEntity">Apply to entity</param>
        /// <param name="entityTypes">Entity types</param>
        public static void SubscribeQuery(Func<QueryDataEvent, DataAccessEventExecutionResult> eventHandleOperation, bool applyToEntity = false, params Type[] entityTypes)
        {
            if (eventHandleOperation == null || (applyToEntity && entityTypes.IsNullOrEmpty()))
            {
                return;
        ...
        /// <param name="applyToEntity">Apply to entity</param>
        /// <param name="entityTypes">Entity types</param>
        public static void SubscribeCheckData(Func<CheckDataEvent, DataAccessEventExecutionResult> eventHandleOperation, bool applyToEntity = false, params Type[] entityTypes)
        {
            if (eventHandleOperation == null || (applyToEntity && entityTypes.IsNullOrEmpty()))
            {
                return;
        ...
        /// <param name="applyToEntity">Apply to entity</param>
        /// <param name="entityTypes">Entity types</param>
        public static void SubscribeAggregateFunction(Func<AggregateFunctionEvent, DataAccessEventExecutionResult> eventHandleOperation, bool applyToEntity = false, params Type[] entityTypes)
        {
            if (eventHandleOperation == null || (applyToEntity && entityTypes.IsNullOrEmpty()))
            {
                return;
