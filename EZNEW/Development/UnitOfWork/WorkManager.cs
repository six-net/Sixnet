...
namespace EZNEW.Development.UnitOfWork
{
    ...
    public class WorkManager
    {
        ...
        public static async Task<IEnumerable<T>> QueryAsync<T>(ICommand command) where T : BaseEntity<T>, new()
        {
            ...
            return await CommandExecutionManager.QueryAsync<T>(command).ConfigureAwait(false);
        }
        ...
        public static async Task<PagingInfo<T>> QueryPagingAsync<T>(ICommand command) where T : BaseEntity<T>, new()
        {
            ...
            return await CommandExecutionManager.QueryPagingAsync<T>(command).ConfigureAwait(false);
        }
        ...
        public static async Task<T> QuerySingleAsync<T>(ICommand command) where T : BaseEntity<T>, new()
        {
            ...
            var datas = await CommandExecutionManager.QueryAsync<T>(command).ConfigureAwait(false);
        ...
        {
            return await CommandExecutionManager.AggregateValueAsync<T>(command).ConfigureAwait(false);
        }
        ...
        {
            return await CommandExecutionManager.QueryMultipleAsync(command).ConfigureAwait(false);
        }
        ...
        {
            return await ExecuteAsync(CommandExecutionOptions.Default, commands).ConfigureAwait(false);
        }
        ...
        public static async Task<int> ExecuteAsync(CommandExecutionOptions executeOptions, params ICommand[] commands)
        {
            IEnumerable<ICommand> cmdCollection = commands;
        ...
        /// <param name="commands">Commands</param>
        /// <returns>Return the effect data number</returns>
        public static async Task<int> ExecuteAsync(CommandExecutionOptions executeOptions, IEnumerable<ICommand> commands)
        {
            if (commands.IsNullOrEmpty())
            {
                return await Task.FromResult(0).ConfigureAwait(false);
            }
            return await CommandExecutionManager.ExecuteAsync(executeOptions ?? CommandExecutionOptions.Default, commands).ConfigureAwait(false);
        }
        ...
        public static int Execute(CommandExecutionOptions executeOptions, params ICommand[] commands)
        {
        ...
        public static int Execute(CommandExecutionOptions executeOptions, IEnumerable<ICommand> commands)
        {
            return ExecuteAsync(executeOptions, commands).Result;
        }
        ...
        /// <param name="executeOptions">Execute options</param>
        /// <returns>Return data effects number</returns>
        public static int Execute(string commandText, object parameters = null, CommandTextType commandTextType = CommandTextType.Text, CommandExecutionOptions executeOptions = null)
        {
