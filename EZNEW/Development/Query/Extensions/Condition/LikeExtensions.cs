...
namespace EZNEW.Development.Query
{
    public static class LikeExtensions
    {
        ...
        {
            return sourceQuery.AddCriterion(or ? ConditionConnectionOperator.OR : ConditionConnectionOperator.AND, fieldName, CriterionOperator.Like, value, criterionOptions);
        }
        ...
        {
            return sourceQuery.AddCriterion(or ? ConditionConnectionOperator.OR : ConditionConnectionOperator.AND, ExpressionHelper.GetExpressionPropertyName(field.Body), CriterionOperator.Like, value, criterionOptions);
        }
    }
}
