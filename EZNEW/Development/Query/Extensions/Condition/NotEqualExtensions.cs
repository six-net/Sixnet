...
namespace EZNEW.Development.Query
{
    public static class NotEqualExtensions
    {
        ...
        public static IQuery NotEqual(this IQuery sourceQuery, string fieldName, dynamic value, bool or = false, CriterionOptions criterionOptions = null)
        {
            return CriterionOperatorExtensions.Add(sourceQuery, CriterionOperator.NotEqual, fieldName, value, or, criterionOptions);
        }
        ...
        {
            return CriterionOperatorExtensions.Add(sourceQuery, CriterionOperator.NotEqual, fieldName, subquery, subqueryFieldName, or);
        }
        ...
        /// <param name="criterionOptions">Criterion options</param>
        /// <returns>Return the newest IQuery object</returns>
        public static IQuery NotEqual<TQueryModel>(this IQuery sourceQuery, Expression<Func<TQueryModel, dynamic>> field, dynamic value, bool or = false, CriterionOptions criterionOptions = null) where TQueryModel : IQueryModel<TQueryModel>
        {
            return CriterionOperatorExtensions.Add(sourceQuery, CriterionOperator.NotEqual, field, value, or, criterionOptions);
        }
        ...
        {
            return CriterionOperatorExtensions.Add(sourceQuery, CriterionOperator.NotEqual, field, subquery, or);
        }
        ...
        {
            return CriterionOperatorExtensions.Add(sourceQuery, CriterionOperator.NotEqual, field, subquery, subqueryField, or);
        }
    }
}
