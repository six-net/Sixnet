...
namespace EZNEW.Development.Query
{
    public static class EndLikeExtensions
    {
        ...
        {
            return sourceQuery.AddCriterion(or ? CriterionConnectionOperator.Or : CriterionConnectionOperator.And, fieldName, CriterionOperator.EndLike, value, criterionOptions);
        }
        ...
        {
            return sourceQuery.AddCriterion(or ? CriterionConnectionOperator.Or : CriterionConnectionOperator.And, ExpressionHelper.GetExpressionPropertyName(field.Body), CriterionOperator.EndLike, value, criterionOptions);
        }
    }
}
