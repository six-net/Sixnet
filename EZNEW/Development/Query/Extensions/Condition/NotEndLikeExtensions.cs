...
namespace EZNEW.Development.Query
{
    public static class NotEndLikeExtensions
    {
        ...
        {
            return sourceQuery.AddCriterion(or ? ConditionConnectionOperator.OR : ConditionConnectionOperator.AND, fieldName, CriterionOperator.NotEndLike, value, criterionOptions);
        }
        ...
        {
            return sourceQuery.AddCriterion(or ? ConditionConnectionOperator.OR : ConditionConnectionOperator.AND, ExpressionHelper.GetExpressionPropertyName(field.Body), CriterionOperator.NotEndLike, value, criterionOptions);
        }
    }
}
