...
namespace EZNEW.Development.Query
{
    public static class EqualRightJoinExtensions
    {
        ...
        {
            return sourceQuery.RightJoin(sourceField, targetField, CriterionOperator.Equal, joinQuery);
        }
        ...
        /// <param name="sourceQuery">Source query</param>
        /// <returns></returns>
        public static IQuery EqualRightJoin<TTarget>(this IQuery sourceQuery) where TTarget : IQueryModel<TTarget>
        {
            return EqualRightJoin<TTarget>(sourceQuery, null);
        }
        ...
        /// <returns></returns>
        public static IQuery EqualRightJoin<TTarget>(this IQuery sourceQuery, Expression<Func<TTarget, bool>> targetFilter) where TTarget : IQueryModel<TTarget>
        {
            return sourceQuery.Join(JoinType.RightJoin, CriterionOperator.Equal, targetFilter);
        }
