...
namespace EZNEW.Development.Query
{
    public static class LessThanOrEqualInnerJoinExtensions
    {
        ...
        {
            return sourceQuery.InnerJoin(sourceField, targetField, CriterionOperator.LessThanOrEqual, joinQuery);
        }
        ...
        /// <param name="sourceQuery">Source query</param>
        /// <returns></returns>
        public static IQuery LessThanOrEqualInnerJoin<TTarget>(this IQuery sourceQuery) where TTarget : IQueryModel<TTarget>
        {
            return LessThanOrEqualInnerJoin<TTarget>(sourceQuery, null);
        }
        ...
        /// <returns></returns>
        public static IQuery LessThanOrEqualInnerJoin<TTarget>(this IQuery sourceQuery, Expression<Func<TTarget, bool>> targetFilter) where TTarget : IQueryModel<TTarget>
        {
            return sourceQuery.Join(JoinType.InnerJoin, CriterionOperator.LessThanOrEqual, targetFilter);
        }
