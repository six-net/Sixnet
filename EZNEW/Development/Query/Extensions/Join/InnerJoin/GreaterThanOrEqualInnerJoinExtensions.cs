...
namespace EZNEW.Development.Query
{
    public static class GreaterThanOrEqualInnerJoinExtensions
    {
        ...
        {
            return sourceQuery.InnerJoin(sourceField, targetField, CriterionOperator.GreaterThanOrEqual, joinQuery);
        }
        ...
        /// <param name="sourceQuery">Source query</param>
        /// <returns></returns>
        public static IQuery GreaterThanOrEqualInnerJoin<TTarget>(this IQuery sourceQuery) where TTarget : IQueryModel<TTarget>
        {
            return GreaterThanOrEqualInnerJoin<TTarget>(sourceQuery, null);
        }
        ...
        /// <returns></returns>
        public static IQuery GreaterThanOrEqualInnerJoin<TTarget>(this IQuery sourceQuery, Expression<Func<TTarget, bool>> targetFilter) where TTarget : IQueryModel<TTarget>
        {
            return sourceQuery.Join(JoinType.InnerJoin, CriterionOperator.GreaterThanOrEqual, targetFilter);
        }
