...
namespace EZNEW.Development.Query
{
    public static class GreaterThanOrEqualLeftJoinExtensions
    {
        ...
        {
            return sourceQuery.LeftJoin(sourceField, targetField, CriterionOperator.GreaterThanOrEqual, joinQuery);
        }
        ...
        /// <param name="sourceQuery">Source query</param>
        /// <returns></returns>
        public static IQuery GreaterThanOrEqualLeftJoin<TTarget>(this IQuery sourceQuery) where TTarget : IQueryModel<TTarget>
        {
            return GreaterThanOrEqualLeftJoin<TTarget>(sourceQuery, null);
        }
        ...
        /// <returns></returns>
        public static IQuery GreaterThanOrEqualLeftJoin<TTarget>(this IQuery sourceQuery, Expression<Func<TTarget, bool>> targetFilter) where TTarget : IQueryModel<TTarget>
        {
            return sourceQuery.Join(JoinType.LeftJoin, CriterionOperator.GreaterThanOrEqual, targetFilter);
        }
