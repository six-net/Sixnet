...
namespace EZNEW.Development.Query
{
    public static class LessThanLeftJoinExtensions
    {
        ...
        {
            return sourceQuery.LeftJoin(sourceField, targetField, CriterionOperator.LessThan, joinQuery);
        }
        ...
        /// <param name="sourceQuery">Source query</param>
        /// <returns></returns>
        public static IQuery LessThanLeftJoin<TTarget>(this IQuery sourceQuery) where TTarget : IQueryModel<TTarget>
        {
            return LessThanLeftJoin<TTarget>(sourceQuery, null);
        }
        ...
        /// <returns></returns>
        public static IQuery LessThanLeftJoin<TTarget>(this IQuery sourceQuery, Expression<Func<TTarget, bool>> targetFilter) where TTarget : IQueryModel<TTarget>
        {
            return sourceQuery.Join(JoinType.LeftJoin, CriterionOperator.LessThan, targetFilter);
        }
