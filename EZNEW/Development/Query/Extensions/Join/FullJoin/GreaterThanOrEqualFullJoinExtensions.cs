...
namespace EZNEW.Development.Query
{
    public static class GreaterThanOrEqualFullJoinExtensions
    {
        ...
        {
            return sourceQuery.FullJoin(sourceField, targetField, CriterionOperator.GreaterThanOrEqual, joinQuery);
        }
        ...
        /// <param name="sourceQuery">Source query</param>
        /// <returns></returns>
        public static IQuery GreaterThanOrEqualFullJoin<TTarget>(this IQuery sourceQuery) where TTarget : IQueryModel<TTarget>
        {
            return GreaterThanOrEqualFullJoin<TTarget>(sourceQuery, null);
        }
        ...
        /// <returns></returns>
        public static IQuery GreaterThanOrEqualFullJoin<TTarget>(this IQuery sourceQuery, Expression<Func<TTarget, bool>> targetFilter) where TTarget : IQueryModel<TTarget>
        {
            return sourceQuery.Join(JoinType.FullJoin, CriterionOperator.GreaterThanOrEqual, targetFilter);
        }
