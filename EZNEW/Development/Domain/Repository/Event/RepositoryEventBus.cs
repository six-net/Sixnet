...
namespace EZNEW.Development.Domain.Repository.Event
{
    ...
    public static class RepositoryEventBus
    {
        ...
        public static void SubscribeModify(Type eventSourceType, Type objectType, Type eventHandlerType, string actionName)
        {
            ...
            var actionMember = eventHandler.GetType().GetMethod(actionName, new Type[] { typeof(IModification), typeof(IQuery) });
            if (actionMember == null)
            {
                return;
            }
        ...
        public static void PublishDataOperation<TObject>(Type eventSource, EventType eventType, IEnumerable<TObject> datas, ActivationOptions activationOptions, RepositoryEventCallback callback = null)
        {
            ...
            {
                callback?.Invoke(DataOperationEventExecutionResult.Empty);
                return;
            }
        ...
        /// <param name="activationOptions">Activation options</param>
        /// <param name="callback">Callback</param>
        public static void PublishModify<TObject>(Type eventSource, IModification modify, IQuery query, ActivationOptions activationOptions = null, RepositoryEventCallback callback = null)
        {
    ...
    public delegate void RepositoryEventCallback(IRepositoryEventExecutionResult result);
}
