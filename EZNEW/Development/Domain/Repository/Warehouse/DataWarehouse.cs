...
namespace EZNEW.Development.Domain.Repository.Warehouse
{
    ...
    public class DataWarehouse<TEntity> : IDataWarehouse where TEntity : BaseEntity<TEntity>, new()
    {
        ...
        /// Modify expression
        /// </summary>
        readonly List<Tuple<IModification, IQuery>> modifyExpressionCollection = new List<Tuple<IModification, IQuery>>();
        ...
        public void Modify(IModification modifyExpression, IQuery query)
        {
            ...
            modifyExpressionCollection.Add(new Tuple<IModification, IQuery>(modifyExpression, query));
