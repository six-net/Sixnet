...
namespace EZNEW.Development.Domain.Repository
{
    ...
    public abstract class DefaultAggregationThreeRelationRepository<TModel, TFirstRelationModel, TSecondRelationModel, TThirdRelationModel, TEntity, TDataAccess>
        : BaseAggregationThreeRelationRepository<TModel, TFirstRelationModel, TSecondRelationModel, TThirdRelationModel, TEntity, TDataAccess>
        where TModel : class, IAggregationRoot<TModel>
        where TSecondRelationModel : IAggregationRoot<TSecondRelationModel>
        where TFirstRelationModel : IAggregationRoot<TFirstRelationModel>
        where TThirdRelationModel : IAggregationRoot<TThirdRelationModel>
