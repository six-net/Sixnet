...
namespace EZNEW.Configuration
{
    public static class ParameterOptionExtensions
    {
        ...
        public static void AddWorkId(this IParameterOptions parameterOptions, string workId = "", bool overCurrent = false)
        {
            ...
            AddParameter(parameterOptions, EZNEWConstants.InternalParameterNames.WorkId, currentWorkId, overCurrent);
        }
        ...
        {
            AddParameter(parameterOptions, EZNEWConstants.InternalParameterNames.TemplateMessageId, messageId, overCurrent);
        }
    }
}
